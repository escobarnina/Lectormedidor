...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Listado de gestiones</span>
        </li>
    </ul>
</div>
@endsection
...
<h3 class="page-title"> Listado de gestiones
...
<div class="row" >
    ...
    <div class="form-group col-md-1">
        <a class="btn sbold orange" href="{{url('gestion/create')}}"> Nuevo
	    ...
	    <div class="portlet box oranget">
	        <div class="portlet-title">
	            <div class="caption colorwhite">
	                <i class="fa fa-user colorwhite"></i>Listado de gestiones </div>
	        </div>
      ...
      $.ajax({
        ...
        success: function( response ) {
          if (response.codigo==0) {
            ...
            setTimeout(function(){window.location = "/gestion"} , 1000);   
