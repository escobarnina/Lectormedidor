        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
     	...
     	<div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="nombres" name="nombres" class="form-control form-control-sm" placeholder="Nombres" required="">
            </div>
            <div class="form-group col-md-6">
                <label>Apellidos <strong class="required" aria-required="true">*</strong></label>
                <input type="text" id="apellidos" name="apellidos" class="form-control form-control-sm" placeholder="Apellidos" required="">
            </div>       
        </div>
     	...
     	<div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="celular" name="celular" class="form-control form-control-sm" placeholder="Celular" required="">
            </div>
            <div class="form-group col-md-6">
                <label>Ci <strong class="required" aria-required="true">*</strong></label>
                <input type="text" id="ci" name="ci" class="form-control form-control-sm" placeholder="Ci" required="">
            </div>     
        </div>
     	...
     	<div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" id="nombreFactura" name="nombreFactura" class="form-control form-control-sm" placeholder="Nombre factura" required="">
            </div>     
        </div>
     	<div class="form-row">
            <div class="form-group col-md-6">
                <label>Direccion <strong class="required" aria-required="true">*</strong></label>
                <input type="text" id="direccion" name="direccion" class="form-control form-control-sm" placeholder="Direccion" required="">
            </div>
            <div class="form-group col-md-6">
                <label>Referencia <strong class="required" aria-required="true">*</strong></label>
                <input type="text" id="referencia" name="referencia" class="form-control form-control-sm" placeholder="Referencia" required="">
            </div>     
        </div>
        ...
        <div class="form-row">
      	...
      	<div class="form-row">
            <div class="form-group col-md-6">
             ...
             <div class="form-group col-md-6">
                <label>Password <strong class="required" aria-required="true">*</strong></label>
     	...
     	<div class="form-row">
              ...
              <div class="image-upload-wrap">
                <input class="file-upload-input" type='file' name="perfil" onchange="readURL(this);" accept="image/jpg, image/jpeg,image/png" required=""/>
                <div class="drag-text">
