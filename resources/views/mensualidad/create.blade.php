...
<h3 class="page-title"> Nuevo mensualidad
</h3>
        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
     	...
     	<div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <select class="js-example-basic-single" id="idGestion" name="idGestion" required>
                    <option></option>
