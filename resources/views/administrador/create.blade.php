...
<h3 class="page-title"> Nuevo administrador
</h3>
        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
     	...
     	<div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="name" name="name" class="form-control form-control-sm" placeholder="Nombre" required="">
            </div>
             <div class="form-group col-md-6">
