...
<head>
    ...
    <link href="{{ asset('public/assets/global/css/components-md.min.css') }}" rel="stylesheet" id="style_components"
        type="text/css" />
...
<body class=" login">
    ...
    <div class="content">
        ...
        <form class="login-form" method="POST" action="{{ url('login/iniciarSesion') }}">
            @csrf
            ...
            <div class="input-group">
                ...
                <input type="password" id="credencial" class="form-control" name="credencial" placeholder="Password" />
    ...
    <div class="copyright"> 2022 © Derechos reservados. </div>
    ...
    <!-- END CORE PLUGINS -->
    <!-- BEGIN PAGE LEVEL PLUGINS -->
    <script src="{{ asset('public/assets/global/plugins/jquery-validation/js/jquery.validate.min.js') }}" type="text/javascript">
    </script>
    ...
    <script>
        let passwordInput = document.getElementById('credencial'),
