...
<h3 class="page-title"> Editar ciudad con nombre <strong>{{$ciudad->nombre}}</strong>
...
<div class="row portlet-body">
    ...
    <form method="post" action="" id="formulario" enctype="multipart/form-data">
    	...
    	<input type="hidden" id="id" name="id" value="{{$ciudad->id}}">

        <div class="form-row">
            <div class="form-group col-md-6">
                <label>Nombre  <strong class="required" aria-required="true">*</strong></label>
                <input type="text" id="nombre" name="nombre" class="form-control form-control-sm" placeholder="Nombre" required="" value="{{$ciudad->nombre}}">
            </div>
            <div class="form-group col-md-6">
                <label>Tarifa por m3 <strong class="required" aria-required="true">*</strong></label>
                <input type="text" id="tarifa" name="tarifa" class="form-control form-control-sm" placeholder="Tarifa" required="" value="{{$ciudad->tarifa}}">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="number" id="digitosEnterosMedidor" name="digitosEnterosMedidor" class="form-control form-control-sm" placeholder="Digitos enteros del medidor" required="" value="{{$ciudad->digitosEnterosMedidor}}">
            </div>
            <div class="form-group col-md-6">
                <label>Digitos decimales del medidor<strong class="required" aria-required="true">*</strong></label>
                <input type="number" id="digitosDecimalesMedidor" name="digitosDecimalesMedidor" class="form-control form-control-sm" placeholder="Digitos decimales del medidor" required="" value="{{$ciudad->digitosDecimalesMedidor}}">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
              ...
              <div class="image-upload-wrap">
                <input class="file-upload-input" type='file' name="bandera" onchange="readURL(this);" accept="image/jpg, image/jpeg,image/png"/>
                <div class="drag-text">
...
$(document).ready(function(){
    ...
    var ciudad = {!! json_encode($ciudad) !!};
    var bandera = ciudad.bandera;
    if (bandera!=null) {
    	bandera = bandera.substring(1,bandera.length);
    	$('.file-upload-image').attr('src',`{{asset('`+bandera+`')}}`);
