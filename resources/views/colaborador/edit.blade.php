...
<h3 class="page-title"> Editar colaborador con nombre <strong>{{$colaborador->nombres}}</strong>
</h3>
...
<div class="row portlet-body">
    ...
    <form method="post" action="" id="formulario" enctype="multipart/form-data">
        ...
        <input type="hidden" name="id" value="{{ $colaborador->id }}">
     	...
     	<div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="nombres" name="nombres" class="form-control form-control-sm" placeholder="Nombres" required="" value="{{$colaborador->nombres}}">
            </div>
            <div class="form-group col-md-6">
                <label>Apellidos <strong class="required" aria-required="true">*</strong></label>
                <input type="text" id="apellidos" name="apellidos" class="form-control form-control-sm" placeholder="Apellidos" required="" value="{{$colaborador->apellidos}}">
            </div>       
        </div>
     	...
     	<div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="celular" name="celular" class="form-control form-control-sm" placeholder="Celular" required="" value="{{$colaborador->celular}}">
            </div>
            <div class="form-group col-md-6">
                <label>Ci <strong class="required" aria-required="true">*</strong></label>
                <input type="text" id="ci" name="ci" class="form-control form-control-sm" placeholder="Ci" required="" value="{{$colaborador->ci}}">
            </div>     
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <select class="js-example-basic-single" id="idCiudad" name="idCiudad">
                    ...
                    @foreach($ciudades as $item)
                    	@if($colaborador->idCiudad==$item->id)
      	...
      	<div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="email" id="email" name="email" class="form-control form-control-sm" placeholder="Nombre" required="" value="{{$colaborador->email}}">
            </div>
             <div class="form-group col-md-6">
        ...
        <div class="form-body col-md-12" style="margin-top: 1em;">
            ...
            <a type="button" href="{{url('colaborador')}}" class="btn plomo">Cancelar</a>
        </div>
...
$(document).ready(function(){
    ...
    var colaborador = {!! json_encode($colaborador) !!};
   

    var perfil = colaborador.perfil;
    if (perfil!=null) {
			...
			$.ajax({
				...
				success: function( response ) {
					if (response.codigo==0) {
						...
						setTimeout(function(){window.location = "/colaborador"} , 2000);   
