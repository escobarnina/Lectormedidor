...
<h3 class="page-title"> Listado de colaboradores
...
<div class="row" >
    ...
    <div class="form-group col-md-1">
        <a class="btn sbold orange" href="{{url('colaborador/create')}}"> Nuevo
	    ...
	    <div class="portlet box oranget">
	        <div class="portlet-title">
	            <div class="caption colorwhite">
	                <i class="fa fa-user colorwhite"></i>Listado de colaboradores </div>
	        </div>
...
$(document).ready(function(){
    ...
    function paginar(page,busqueda, parametro){
        var url = "{{url('colaborador/search')}}";
        $.ajax({
            type : 'GET',
            url : url+'?page='+page,
            data : {valor:busqueda, parametro: parametro},
      ...
      $.ajax({
        ...
        success: function( response ) {
          if (response.codigo==0) {
            ...
            setTimeout(function(){window.location = "/colaborador"} , 1000);   
