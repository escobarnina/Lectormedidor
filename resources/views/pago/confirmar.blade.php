...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md">
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <!-- BEGIN CONTENT BODY -->
            <div class="container">
                <h4 style="margin-bottom: 1em;"> Los campos con <strong style="color: red;">*</strong> son obligatorios
                </h4>
                    ...
                    <form method="post" action="{{ $endpoint_url }}" id="formulario" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label>Número de tarjeta <strong class="required"
                                        aria-required="true">*</strong></label>
                                <input type="tel" id="card_number" class="form-control form-control-sm"
                                    placeholder="Número de tarjeta" value="{{ $params['card_number'] }}"
                                    readonly="">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="bill_to_forename" class="form-control form-control-sm"
                                    placeholder="Nombres" value="{{ $params['bill_to_forename'] }}" readonly="">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Apellidos <strong class="required" aria-required="true">*</strong></label>
                                <input type="text" id="bill_to_surname" class="form-control form-control-sm"
                                    placeholder="Apellidos" value="{{ $params['bill_to_surname'] }}" readonly="">
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Correo electrónico <strong class="required"
                                        aria-required="true">*</strong></label>
                                <input type="email" id="bill_to_email" class="form-control form-control-sm"
                                    placeholder="Correo electrónico" value="{{ $params['bill_to_email'] }}"
                                    readonly="">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Número de celular <strong class="required"
                                        aria-required="true">*</strong></label>
                                <input type="number" id="bill_to_phone" class="form-control form-control-sm"
                                    placeholder="Número de celular" value="{{ $params['bill_to_phone'] }}"
                                    readonly="">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="single-append-text" class="control-label">Seleccione la ciudad <strong
                                        class="required" aria-required="true">*</strong></label>
                                @if ($params['bill_to_address_state'] == 'BOS')
                                    <input type="text" class="form-control form-control-sm" value="Santa Cruz"
                                        readonly="">
                                @endif
                                @if ($params['bill_to_address_state'] == 'BOH')
                                    <input type="text" class="form-control form-control-sm" value="Chuquisaca"
                                        readonly="">
                                @endif
                                @if ($params['bill_to_address_state'] == 'BOC')
                                    <input type="text" class="form-control form-control-sm" value="Cochabamba"
                                        readonly="">
                                @endif
                                @if ($params['bill_to_address_state'] == 'BOB')
                                    <input type="text" class="form-control form-control-sm" value="Beni"
                                        readonly="">
                                @endif
                                @if ($params['bill_to_address_state'] == 'BOL')
                                    <input type="text" class="form-control form-control-sm" value="La Paz"
                                        readonly="">
                                @endif
                                @if ($params['bill_to_address_state'] == 'BOO')
                                    <input type="text" class="form-control form-control-sm" value="Oruro"
                                        readonly="">
                                @endif
                                @if ($params['bill_to_address_state'] == 'BON')
                                    <input type="text" class="form-control form-control-sm" value="Pando"
                                        readonly="">
                                @endif
                                @if ($params['bill_to_address_state'] == 'BOP')
                                    <input type="text" class="form-control form-control-sm" value="Potosi"
                                        readonly="">
                                @endif
                                @if ($params['bill_to_address_state'] == 'BOT')
                                    <input type="text" class="form-control form-control-sm" value="Tarija"
                                        readonly="">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="tel" id="card_expiry_date" class="form-control form-control-sm"
                                    placeholder="MM/YYYY" value="{{ $params['card_expiry_date'] }}" readonly="">
                            </div>
                            <div class="form-group col-md-6">
                                <label>CVN <strong class="required" aria-required="true">*</strong></label>
                                <input type="number" id="card_cvn" class="form-control form-control-sm"
                                    placeholder="CVN" value="{{ $params['card_cvn'] }}" readonly="">
                            </div>
                        </div>
