...
<head>
    ...
    <script type="text/javascript"
        src="https://h.online-metrix.net/fp/tags.js?org_id={{ $df_org_id }}&session_id={{ $merchant_id }}{{ $session_id }}">
    </script>
        ...
        <div class="page-content-wrapper">
            ...
            <div class="container">
                ...
                <div class="row portlet-body">
                    ...
                    <form method="post" action="{{ url('api/pago/confirmar') }}" id="formulario"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="tel" id="card_number" name="card_number"
                                    class="form-control form-control-sm" placeholder="Número de tarjeta"
                                    value="" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="bill_to_forename" name="bill_to_forename"
                                    class="form-control form-control-sm" placeholder="Nombres" value=""
                                    required="">
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="bill_to_surname" name="bill_to_surname"
                                    class="form-control form-control-sm" placeholder="Apellidos" value=""
                                    required="">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Correo electrónico <strong class="required"
                                        aria-required="true">*</strong></label>
                                <input type="email" id="bill_to_email" name="bill_to_email"
                                    class="form-control form-control-sm" placeholder="Correo electrónico"
                                    value="" required="">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Número de celular <strong class="required"
                                        aria-required="true">*</strong></label>
                                <input type="number" id="bill_to_phone" name="bill_to_phone"
                                    class="form-control form-control-sm" placeholder="Número de celular"
                                    value="" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <select class="js-example-basic-single" id="bill_to_address_state"
                                    name="bill_to_address_state" required>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="tel" id="card_expiry_date" name="card_expiry_date"
                                    class="form-control form-control-sm" placeholder="MM/YYYY" value=""
                                    required="">
                            </div>
                            <div class="form-group col-md-6">
                                <label>CVN <strong class="required" aria-required="true">*</strong></label>
                                <input type="number" id="card_cvn" name="card_cvn"
                                    class="form-control form-control-sm" placeholder="CVN" value=""
                                    required="">
                            </div>
                        </div>
                        <br>
